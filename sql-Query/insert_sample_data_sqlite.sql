...
('Trần Văn Tú', NULL, '0911472583', 'Trần Thị Mai', 'Hà Nội', 'Số 5 Đường DEF, Hà Nội', '2011-02-28', 'Nam', 1),
...
('Trịnh Thu Thủy', NULL, '0978123456', 'Đỗ Thị Lan', 'Hải Phòng', 'Số 15 Đường ASD, Hải Phòng', '2009-09-09', 'Nữ', NULL);
...
(3, 22000000.00, NULL); -- Giáo viên này chưa có thưởng
...
(5, 5000000.00, 0),
(6, 5000000.00, 1),
(7, 5000000.00, NULL), -- Chưa rõ đã đóng chưa
(8, 5000000.00, 1),
(9, 5000000.00, 0);
